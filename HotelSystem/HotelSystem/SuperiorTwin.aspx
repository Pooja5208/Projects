<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SuperiorTwin.aspx.cs" Inherits="HotelSystem.SuperiorTwin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="GridView4" position="center" runat="server" AutoGenerateColumns="False" ForeColor="#333333" HorizontalAlign="Center" OnRowCommand="GridView4_RowCommand1">
