<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Standardking.aspx.cs" Inherits="HotelSystem.Standardking" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="GridView1" position="center" runat="server" AutoGenerateColumns="False" ForeColor="#333333" OnRowCommand="GridView1_RowCommand" HorizontalAlign="Center">
     ...
     <Columns>
            ...
            <asp:BoundField DataField="room_no" HeaderText="Room No" SortExpression="room_no" ItemStyle-Width="50px">
            ...
            <ItemStyle HorizontalAlign="Center" Font-Bold="True" Font-Size="Large" VerticalAlign="Middle" Width="150px" />
             ...
             <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
             <ItemStyle BorderStyle="Double" Font-Bold="True" HorizontalAlign="Center" VerticalAlign="Middle" Width="150px" />
             </asp:ButtonField>
