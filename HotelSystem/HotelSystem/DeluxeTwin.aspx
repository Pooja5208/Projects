<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DeluxeTwin.aspx.cs" Inherits="HotelSystem.DeluxeTwin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="GridView2" position="center" runat="server" AutoGenerateColumns="False" ForeColor="#333333" HorizontalAlign="Center" OnRowCommand="GridView2_RowCommand">
