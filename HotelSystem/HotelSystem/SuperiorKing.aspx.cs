...
{
    public partial class SuperiorKing : System.Web.UI.Page
    {
        SqlConnection con = new SqlConnection(@"Data Source=.;Initial Catalog=hotel_db;Integrated Security=True");
        protected void Page_Load(object sender, EventArgs e)
        {
            string strsql = "select * from tbl_Rooms where category like 'Superior King Room'";
        ...
        protected void GridView5_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Select")
            {
                ...
                GridViewRow row1 = GridView5.Rows[rowIndex];
