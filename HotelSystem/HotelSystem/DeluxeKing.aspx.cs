...
{
    public partial class DeluxeKing : System.Web.UI.Page
    {
        SqlConnection con = new SqlConnection(@"Data Source=.;Initial Catalog=hotel_db;Integrated Security=True");
        protected void Page_Load(object sender, EventArgs e)
        {
            string strsql = "select * from tbl_Rooms where category like 'Deluxe King Room'";
        ...
        protected void GridView3_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Select")
            {
                ...
                GridViewRow row1 = GridView3.Rows[rowIndex];
