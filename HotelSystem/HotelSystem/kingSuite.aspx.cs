...
{
    public partial class kingSuite : System.Web.UI.Page
    {
        SqlConnection con = new SqlConnection(@"Data Source=.;Initial Catalog=hotel_db;Integrated Security=True");
        protected void Page_Load(object sender, EventArgs e)
        {
            string strsql = "select * from tbl_Rooms where category like 'King Suite Room'";
        ...
        protected void GridView8_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Select")
            {
                ...
                GridViewRow row1 = GridView8.Rows[rowIndex];
